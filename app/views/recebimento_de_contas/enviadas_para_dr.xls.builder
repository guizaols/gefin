  ...
  xml.Worksheet 'ss:Name' => 'Envio ao DR' do
    xml.Table do
      ...
      xml.Row do
        ...
        xml.Cell { xml.Data 'Data de Envio ao DR', 'ss:Type' => 'String' }
      end
      ...
      @parcelas_para_excel.each do |parcela|
        ...
        # if(parcela.data_envio_ao_dr.to_date <= params[:data_final].to_date)
        xml.Row do
          ...
          xml.Cell { xml.Data parcela.conta.numero_de_controle, 'ss:Type' => 'String' }
           xml.Cell { xml.Data parcela.data_envio_ao_dr, 'ss:Type' => 'String' }
          ids_pessoas << pessoa.id
