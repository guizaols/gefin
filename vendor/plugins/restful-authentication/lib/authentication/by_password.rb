  ...
  module ByPassword
    ...
    def self.included( recipient )
      ...
      recipient.class_eval do
        ...
        validates_presence_of     :password,                   :message => 'deve ser preenchida.', :if => :password_required?
        validates_presence_of     :password_confirmation,      :message => 'deve ser preenchida.', :if => :password_required?
        validates_confirmation_of :password,                   :if => :password_required?
        validates_length_of       :password, :message => 'deve ter no minímo 6 caracteres.', :within => 6..40, :if => :password_required?
